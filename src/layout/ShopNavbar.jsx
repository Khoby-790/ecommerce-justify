                    ...
                    <div class="relative flex items-center justify-between h-16">
                        ...
                        <div class="hidden lg:block lg:w-80">
                            <div class="flex flex-row items-center justify-end">
                                ...
                                <div className="relative bg-gray-900 h-13 w-13 cursor-pointer flex justify-center items-center ml-3 rounded-full bg-gray-100">
                                    <svg className="h-11" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
