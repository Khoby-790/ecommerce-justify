...
const FlitersPane = () => {
    ...
    return (
        <Fragment>
            <div class="border-b sm:hidden md:block border-gray-200 dark:border-gray-500 xl:border-b-0 xl:flex-shrink-0 dark:bg-gray-800 xl:w-72 xl:border-r xl:border-gray-200 bg-white">
